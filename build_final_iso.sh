...
# Core & Hardware Firmware Payload
...
# Calamares Branding
mkdir -p config/includes.chroot/etc/calamares/branding/retro-os
cp -r /etc/calamares/* config/includes.chroot/etc/calamares/ 2>/dev/null || true
